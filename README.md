...
Automatically monitor Voicemeeter recordings, transcribe audio using Faster-Whisper, WhisperX, or Parakeet, identify speakers using PyAnnote, and generate clean Markdown transcripts for Obsidian.
